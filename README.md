...
A token is used for authentication and is issued by a server to a client so the server knows who it's dealing with.

2. What steps can you take in your web apps to keep your data secure?

Make sure you use private routes for sensitive information and only allow access if the user has been authenticated.

3. Describe how web servers work.

Web servers host a website and allow the rest of the world to access it through the internet. A server basically listens for requests.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

.Post() can be used to CREATE, .Get() is used to READ, .Put() is used to UPDATE and .Delete() is used to DELETE 
